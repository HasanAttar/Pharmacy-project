...
$query_total_quantity = "SELECT SUM(quantity) AS total_quantity FROM usedorders WHERE medicine_id = '$medicine_id' AND customer_name = '$customer_name'";
...
if ($quantity <= $remaining_quantity) {
    ...
    $query_check_order = "SELECT * FROM usedorders WHERE medicine_id = '$medicine_id' AND customer_name = '$customer_name'";
    ...
    if (mysqli_num_rows($result_check_order) > 0) {
        ...
        $query_update_order = "UPDATE usedorders SET quantity = '$new_quantity' WHERE id = '$order_id'";
        ...
        $query_insert_order = "INSERT INTO usedorders (medicine_id, customer_name, quantity, price, pharmacy_name) VALUES ('$medicine_id', '$customer_name', '$quantity', '$price', '$pharmacy_name')";

...
$query_orders = "SELECT orders.medicine_id, criticalmedicines.Name AS medicine_name, orders.quantity, orders.date_added ,orders.pharmacy_name,orders.price,orders.customer_name FROM orders JOIN criticalmedicines ON orders.medicine_id = criticalmedicines.id WHERE customer_name = '$customer_name'";
        ...
        <div class="container">
          ...
          <div class="menu col-md-7">
            <ul class="list-unstyled list-inline pull-right">
              ...
              <li><a href="viewcritical.php" style="color:white;font-weight:bold;font-size:18px;text-decoration-line:underline">View Critical Medicines</a></li>
      ...
      <div class="col">
        <div class="card mt-5">
          <div class="card-header">
            <h2 class="display-6 text-center" style="color:#1bbbc5">Your Order Of Critical Medicines List</h2>
          </div>
          <div class="col-md-6">

...
$price="";
$discount="";
$query="select * from usedmedicines where id=$id";
...
<?php
    if(isset($_POST['Update']))
    {
        ...
        mysqli_query($con, "UPDATE usedmedicines SET Name='$name', Expirationdate='$expirationdate', Quantity='$quantity', Price='$price', Discount='$discount',total_price='$total_price' WHERE id=$id");

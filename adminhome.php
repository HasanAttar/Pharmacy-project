...
<head>
	...
	<style type="text/css">
		...
		body {
			background: url(images/85.jpg) no-repeat center center fixed;
			...
			<div class="container">
				...
				<div class="menu col-md-7">
					<ul class="list-unstyled list-inline pull-right">
						<li><a href="adminhome.php" style="color:white;font-size:20px;text-decoration-line:underline"><i>Admin Home</i></a></li>
				...
				<div class="cus-bottom" style="margin-top: 5%">
					<div class="container" style="padding-bottom:150px;">
						<div class="img-row1">
							...
							<div class="img col-md-3" style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.9;filter: alpha(opacity=60);text-align: center;margin-left: 0%;padding-top: 2%;padding-bottom: 2%;box-shadow: 5px 10px #989ba0;margin-top: 4%">
								<a href="pending.php">
									<img src="img/82.jpg" alt="" style="max-height: 115px;max-width: 300px;margin-left: 5%">
								</a>
								<br>
								<br>
								<label style="margin-left: 2%">Manage Pharmacist</label>
							</div>
							<div class="img col-md-3" style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.9;filter: alpha(opacity=60);text-align: center;margin-left: 0%;padding-top: 2%;padding-bottom: 2%;box-shadow: 5px 10px #989ba0;margin-top: 4%">
								<a href="ManageCustomer.php">
									<img src="img/83.jpeg" alt="" style="max-height: 115px;max-width: 300px;margin-left: 5%">
								</a>
								<br>
								<br>
								<label style="margin-left: 2%">Manage Customer</label>
							</div>

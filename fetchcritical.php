...
$fetchQuery = "SELECT * FROM criticalmedicines where pharmacy_name='$pharmacy_name' ";
          ...
          <div class="card-body">
            <div class="card-body table-responsive">
              <table class="table table-bordered text-center">
                <tr class="" style="background-color:#1BBBC5;font-size:18px;color:white">
                ...
                <tr style="font-size:15px">
                  ...
                  ?>
                      ...
                      <td><a style="color:white;" href="editcritical.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success" style="background-color:#1BBBC5">Edit</a></td>
                      <td><a style="color:white;" href="deletecritical.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" style="background-color:#1BBBC5">Delete</a></td>
                </tr>
            <?php
                    }
                  }
            ...
            <div class="text-center mt-3">
              <a href="insertcritical.php" class="btn btn-primary" style="background-color:#1BBBC5">Insert</a>

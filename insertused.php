      ...
      <div class="container">
        ...
        <div class="menu col-md-7">
          <ul class="list-unstyled list-inline pull-right">
            <li><a href="fetchused.php" style="color:white;font-weight:bold;font-size:18px;text-decoration-line:underline">Used List</a></li>
...
if (isset($_POST['Insert'])) {
  mysqli_query($con, "INSERT INTO usedmedicines (Name, Expirationdate, Quantity, Price, Discount,pharmacy_name,Region,pharmacist_mobile) VALUES ('$_POST[Name]', '$_POST[Expirationdate]', '$_POST[Quantity]', '$_POST[Price]', '$_POST[Discount]','$pharmacy_name','$region','$mobileNumber')");
  ...
  mysqli_query($con, "UPDATE usedmedicines SET total_price = '$total_price' WHERE Name = '$_POST[Name]' AND pharmacy_name = '$pharmacy_name'");

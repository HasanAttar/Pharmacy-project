...
$query_orders = "SELECT usedorders.id, usedorders.medicine_id, usedmedicines.Name AS medicine_name, usedorders.quantity, usedorders.date_added ,usedorders.pharmacy_name,usedorders.price,usedorders.customer_name, usedorders.is_held FROM usedorders JOIN usedmedicines ON usedorders.medicine_id = usedmedicines.id 
WHERE usedorders.pharmacy_name = '$pharmacy_name' 
AND usedorders.quantity > 0 ";
...
if (isset($_POST['hold'])) {
    ...
    $query_stock = "SELECT quantity FROM usedmedicines WHERE id = $medicine_id";
    ...
    if ($quantity_ordered > $medicine_quantity) {
        ...
        $query_check_hold = "SELECT is_held FROM usedorders WHERE id = $order_id";
        ...
        if ($is_held == 0) {
            $query_used = "UPDATE usedmedicines SET quantity = quantity - $quantity_ordered WHERE pharmacy_name = '$pharmacy_name' AND id = $medicine_id";
            mysqli_query($con, $query_used);
            $query_update_order = "UPDATE usedorders SET is_held = 1 WHERE id = $order_id";
...
<head>
  ...
  background-color: transparent; */
        table {
            ...
            max-width: 800px;
            /* Set a max width for better readability, adjust as needed */
            overflow-x: hidden;
            ...
            <div class="container">
                ...
                <div class="menu col-md-7">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="fetchused.php" style="color:white;font-weight:bold;font-size:18px;text-decoration-line:underline">Used Medicines</a></li>
                    </ul>
                </div>
                                ...
                                <td>
                                    ...
                                    <?php else : ?>
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="hold" style="background-color:#1bbbc5" class="btn btn-primary">Hold</button>
                                        </form>
                                    <?php endif; ?>
                                </td>
                            </tr>
